...
import re
import sys
import os, shutil, time, tempfile, signal, random, string, yaml
...
def parse_compilers(compiler_config_file):
    ...
    for line in lines:
        ...
        with tempfile.NamedTemporaryFile(suffix=".c", mode="w", delete=False) as tmp_f:
            ...
            ret, _ = run_cmd(test_compiler_cmd, COMPILER_TIMEOUT)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="LegoFuzz for compiler backends.")
    parser.add_argument(
        "--src",
        type=str,
