...
def generate_proxy_function_hide_pointer(input_func:Function, synthesized_input:list[str]) -> str:
    # proxy function name
    proxy_function_name = f"lego_proxy_{generate_random_string(5)}"
...
Lego_MISC_PLACEHOLDER

Lego_FUNCTION_PLACEHOLDER
...
def generate_closure_program(proxy_function:Function, input_function:Function, synthesized_intput:list[str]) -> tuple[str, Function]:
    ...
    Lego_FUNCTION_PLACEHOLDER = input_function.function_body
    ...
    closure_program = DRIVER_FUNC\
        .replace(
        "Lego_MISC_PLACEHOLDER", Lego_MISC_PLACEHOLDER)\
        .replace(
        "Lego_FUNCTION_PLACEHOLDER", Lego_FUNCTION_PLACEHOLDER)\
        .replace(
